...
<body>
  <div class="container">
    <h1 class="h1playoff">Play Offs </h1>
    <h2>Counter Strike 2</h2>
    <div class="tournament-bracket tournament-bracket--rounded">

      <div class="tournament-bracket__round tournament-bracket__round--eighthfinals">
        <h3 class="tournament-bracket__round-title">Oitavas de Final</h3>
                ...
                <tbody class="tournament-bracket__content">
                  <tr class="tournament-bracket__team tournament-bracket__team--winner">
                    <td class="tournament-bracket__country">
                      <abbr class="tournament-bracket__code" title="Brasil">BRASIL</abbr>
                      <span class="tournament-bracket__flag flag-icon flag-icon-br" aria-label="Flag"></span>
                    </td>
                  ...
                  <tr class="tournament-bracket__team">
                    <td class="tournament-bracket__country">
                      <abbr class="tournament-bracket__code" title="Chile">CHILE</abbr>
                      <span class="tournament-bracket__flag flag-icon flag-icon-cl" aria-label="Flag"></span>
                    </td>
                    <td class="tournament-bracket__score">
            ...
            <div class="tournament-bracket__match" tabindex="0">
              <table class="tournament-bracket__table">
                ...
                <tbody class="tournament-bracket__content">
                  <tr class="tournament-bracket__team tournament-bracket__team--winner">
                    <td class="tournament-bracket__country">
                      <abbr class="tournament-bracket__code" title="Argentina">ARG</abbr>
                      <span class="tournament-bracket__flag flag-icon flag-icon-ar" aria-label="Flag"></span>
                    </td>
                    <td class="tournament-bracket__score">
                  ...
                  <tr class="tournament-bracket__team">
                    <td class="tournament-bracket__country">
                      <abbr class="tournament-bracket__code" title="Colombia">COL</abbr>
                      <span class="tournament-bracket__flag flag-icon flag-icon-co" aria-label="Flag"></span>
                    </td>
                    <td class="tournament-bracket__score">
